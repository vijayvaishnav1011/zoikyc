...
@esign_bp.route('/debug/test-capricorn', methods=['GET', 'POST'])
@csrf.exempt
def debug_test_capricorn():
    ...
    buf = io.BytesIO()
    c = canvas.Canvas(buf)
    c.drawString(100, 750, 'ZoiKYC Test Agreement from Server')
    c.save()
